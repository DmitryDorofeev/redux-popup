...
var ReduxPopup = (function (_super) {
    ...
    ReduxPopup.prototype.render = function () {
        var _this = this;
        var _a = this.props, Inner = _a.component, Dialog = _a.modal, sequence = _a.popup.sequence, name = _a.name, className = _a.className, type = _a.type, modalProps = __rest(_a, ["component", "modal", "popup", "name", "className", "type"]);
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Dialog, __assign({ active: active && (active.name === name) || false, onClose: function () { return _this.onClose(); }, className: className, type: type }, modalProps),
...
/* harmony default export */ __webpack_exports__["a"] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["connect"])(mapStateToProps, { registerPopup: __WEBPACK_IMPORTED_MODULE_2__actions__["d" /* registerPopup */], closeActivePopup: __WEBPACK_IMPORTED_MODULE_2__actions__["b" /* closeActivePopup */] })(ReduxPopup);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__reducer__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ReduxPopup__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createReduxPopup__ = __webpack_require__(54);
...
function createReduxPopup(name, modal, modalProps, data) {
    if (modalProps === void 0) { modalProps = {}; }
    if (data === void 0) { data = {}; }
    return function (WrappedComponent) {
        return function (props) { return (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__ReduxPopup__["a" /* default */], { name: name, component: WrappedComponent, data: data, modal: modal })); };
    };
}
